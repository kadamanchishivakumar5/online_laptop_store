...
<%@ page import="com.anirudh.service.impl.*,com.anirudhi.service.*"%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<!--  	<li><a href="index.jsp?type=tv">Apple</a></li>
							<li><a href="index.jsp?type=mobile"></a>hp</li>
							<li><a href="index.jsp?type=camera">Dell</a></li>
							<li><a href="index.jsp?type=speaker">Lenovo</a></li>
							<li><a href="index.jsp?type=tablet">Acer</a></li>
							<li><a href="index.jsp?type=tablet">Samsung</a></li>-->
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<!-- 	<li><a href="userHome.jsp?type=tv">Apple</a></li>
							<li><a href="userHome.jsp?type=mobile">hp</a></li>
							<li><a href="userHome.jsp?type=camera">Dell</a></li>
							<li><a href="userHome.jsp?type=speaker">Lenovo</a></li>
							<li><a href="userHome.jsp?type=tablet">Acer</a></li>
							<li><a href="index.jsp?type=tablet">Samsung</a></li> -->
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<!--  <li><a href="adminViewProduct.jsp?type=tv">Apple</a></li>
							<li><a href="adminViewProduct.jsp?type=mobile">hp</a></li>
							<li><a href="adminViewProduct.jsp?type=camera">Dell</a></li>
							<li><a href="adminViewProduct.jsp?type=speaker">Lenovo</a></li>
							<li><a href="adminViewProduct.jsp?type=tablet">Acer</a></li>
									<li><a href="index.jsp?type=tablet">Samsung</a></li>-->
